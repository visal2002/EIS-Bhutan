                ...
                return (
                    <span key={i} className="flex items-center gap-1 min-w-0">
                        ...
                        {isLast ? (
                            ...
                            /* Ancestor with href — clickable link */
                            <Link
                                to={crumb.href}
                            ...
                            /* Ancestor without href — plain text */
                            <span className="text-slate-400 dark:text-slate-500 truncate max-w-[120px] font-medium">
                                {i === 0
                                    ? <span className="flex items-center gap-1"><Home className="h-3.5 w-3.5 inline-block" /><span className="hidden lg:inline">{crumb.label}</span></span>
                                    : crumb.label
                                }
...
// ── Main Header ───────────────────────────────────────────────────
export default function Header({ onMenuClick, onToggleCollapse, isCollapsed, breadcrumb, title }) {
