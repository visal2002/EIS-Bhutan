...
export default function SiteSettingsPage() {
    ...
    const TAB_FIELDS = {
        ...
        system:   ['allow_ndi_login','allow_agency_login','session_timeout','max_login_attempts',
                   'maintenance_mode','maintenance_msg','audit_log_retention_days'],
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (hasFiles) {
                ...
                res = await apiFetch('/admin/site-settings/', {
                    method: 'PATCH',
                    body:   fd,
                });
            } else {
                                ...
                                <div className="space-y-5">
                                    ...
                                    <Section title="Session & Security" icon={Settings}>
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            ...
                                            <Field label="Audit Log Retention (Days)" hint="Auto-cleanup period">
                                                <Input type="number" value={form.audit_log_retention_days || 90}
                                                    onChange={e => set('audit_log_retention_days', Number(e.target.value))}
                                                    min={1} max={3650} />
                                            </Field>
                                        </div>
                                    </Section>
