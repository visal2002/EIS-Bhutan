...
const SOURCE_COLORS = {
    ...
    POL: '#b45309', 'Solar/Renewables': '#eab308',
};
const SECTOR_COLORS = {
...
// ─── trend data ───────────────────────────────────────────────────
const TREND = [
    { y: '2010', hydro: 180000, biomass: 72000, POL: 68000, coal: 55000 },
    { y: '2012', hydro: 198000, biomass: 76000, POL: 79000, coal: 82000 },
    { y: '2014', hydro: 210000, biomass: 80000, POL: 88000, coal: 110000 },
    { y: '2016', hydro: 222500, biomass: 84693, POL: 97500, coal: 149230 },
    { y: '2018', hydro: 248000, biomass: 90000, POL: 108000, coal: 95000 },
    { y: '2020', hydro: 272000, biomass: 96000, POL: 115000, coal: 75000 },
    { y: '2022', hydro: 301852, biomass: 100617, POL: 130000, coal: 78042 },
];
                            ...
                            <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                                ...
                                <ResponsiveContainer width="100%" height={260}>
                                    <AreaChart data={TREND} margin={{ top: 5, right: 10, bottom: 0, left: 0 }}>
                                        ...
                                        <Area type="monotone" dataKey="POL"       name="POL"       stroke="#b45309" fill="url(#petrol)"  strokeWidth={2} />
