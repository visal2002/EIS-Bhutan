...
const REPORTS = [
    ...
    {
        id: 5, category: 'POL', year: 2022,
        title: 'POL Statistics 2022',
        desc: 'Import, distribution and consumption of all POL products across transport, industry and residential sectors.',
...
const CATEGORIES = ['All', 'Energy Balance', 'Electricity', 'GHG', 'POL', 'Biomass', 'Industry', 'Solar', 'Transport', 'Coal'];
