...
MODULES = [
    ...
    ("transport_data",   "Transport Fuel",          "Data Collection"),
...
DEFAULTS = {
    ...
    "DOE_HEAD": {
        ...
        "transport_data":   {"can_view": True,  "can_create": False, "can_edit": True,  "can_delete": False, "can_upload": False, "can_download": True},
