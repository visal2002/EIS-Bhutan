...
class EnergyDataModel(AuditedModel):
    ...
    DATA_SOURCE_CHOICES = [
        ...
        (DATA_SOURCE_API, "API"),
        (DATA_SOURCE_EXCEL, "Excel Upload"),
    ]
    ...
    toe_calculated = models.DecimalField(
        max_digits=18, decimal_places=6, null=True, blank=True
    )
    data_source = models.CharField(
        max_length=20, choices=DATA_SOURCE_CHOICES, default=DATA_SOURCE_MANUAL
    )
