...
urlpatterns = [
    ...
    path("api/electricity/",    include("eis_apps.electricity.urls")),
    path("api/pol/",            include("eis_apps.pol.urls")),
    ...
    path("api/surface-transport/", include("eis_apps.surface_transport.urls")),
    path("api/air-transport/",     include("eis_apps.air_transport.urls")),
    path("api/ghg/",            include("eis_apps.ghg.urls")),
    path("api/reporting/",      include("eis_apps.reporting.urls")),
    path("api/analytics/",      include("eis_apps.analytics.urls")),
