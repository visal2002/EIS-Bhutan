...
class BlockTypeAdmin(ModelAdmin):
    list_display = ["id", "label", "category", "icon", "color"]
    search_fields = ["id", "label", "category"]
    list_filter = ["category"]

@admin.register(LandingPageSection)
class LandingPageSectionAdmin(ModelAdmin):
    list_display = ["id", "name", "order", "icon", "color"]
